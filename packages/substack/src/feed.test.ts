...
/** Two items shaped like exampleletter's feed on 2026-09-10: CDATA text, a guid, and a body that carries markup of its own. */
...
<channel><title><![CDATA[Example Letter]]></title><link>https://exampleletter.substack.com</link>
<item><title><![CDATA[A weekly letter about the week in software.]]></title>
<description><![CDATA[Both moves are really about one question: who can pay for compute.]]></description>
<link>https://exampleletter.substack.com/p/the-weekly-letter</link>
<guid isPermaLink="false">https://exampleletter.substack.com/p/the-weekly-letter</guid>
...
<item><title>Plain &amp; escaped &#8220;title&#8221;</title><link>https://exampleletter.substack.com/p/second</link>
...
describe('a publication feed', () => {
  ...
  it('decodes entities outside CDATA, falls back to the link for an id, and drops an item with neither', () => {
    ...
    expect(posts[1]).toMatchObject({
      id: 'https://exampleletter.substack.com/p/second',
